...
module.exports = function (filePath, settings, infoConfiguration, infoFile) {
	...
	this.fnExtractFrameToJPG = function (/* destinationFolder, settings, callback */) {
		...
		var settings = {
		  ...
		  , quality					: null		// A number from 1-31, with 1 being highest quality/largest filesize and 31 being the lowest quality/smallest filesize
		};
		...
		if(settings.quality)
			this.addCommand('-q:v', settings.quality);
